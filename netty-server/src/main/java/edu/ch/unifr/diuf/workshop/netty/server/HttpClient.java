 ...
 */
package edu.ch.unifr.diuf.workshop.netty.server;
...
public class HttpClient extends Thread {
     ...
     * @param delay
     */
    public HttpClient(URL url, int d_max, int delay) {
        this.max = d_max;
        this.delay = delay;
        this.url = url;
    }
    ...
    private void sendRequest() throws IOException {
        ...
        this.os.write(("User-Agent: " +HttpClient.class.getName() + "\n").getBytes());
    ...
    public static void main(String[] args) throws Exception {
       ...
       /* if (args.length < 1) {
            System.err.println("Usage: java " + HttpClient.class.getName() + " URL [n] [delay] [nreqs]");
        ...
        URL strURL = new URL("http://localhost:9090/");
        ...
        HttpClient clients[] = new HttpClient[NB_CLIENTS];

        for (int i = 0; i < clients.length; i++) {
            clients[i] = new HttpClient(strURL, max, delay);
        }
